...
def calculate_control(robot_x, robot_y, robot_a, goal_x, goal_y):
    ...
    if(error_a<-math.pi):
        error_a=error_a+2*math.pi
    v=v_max*math.exp(-error_a*error_a/alpha)#para la velocidad lineal
    w = w_max*(2/(1 + math.exp(-error_a/beta)) - 1)#para la velocidad angular
...
def main():
    ...
    print "PRACTICE 05 -Fragoso Luna " + NAME
