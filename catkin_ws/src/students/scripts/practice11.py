...
# PRACTICE 11 - TRAINING A NEURAL NETWORK
#
# Instructions:
...
class NeuralNetwork(object):
    ...
    def backpropagate(self, x, yt):
        ...
        # 
        delta = (y[-1]-yt)*y[-1]*(1-y[-1]) #L: delta=(yL-yt)*yL*(1-yL)
	    nabla_b[-1] = delta # nabla_b of output layer = delta  
	    nabla_w[-1] = delta*numpy.transpose(y[-2])  # nabla_w of output layer = delta*yLpT
...
def main():
    print("PRACTICE 11 - " + NAME)
    rospy.init_node("practice11")
