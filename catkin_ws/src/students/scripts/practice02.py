...
def a_star(start_r, start_c, goal_r, goal_c, grid_map, cost_map):
    ...
    #
    open_list 	= []
    in_closed_1	= numpy.full(grid_map.shape, False)
    in_open_1	= numpy.full(grid_map.shape, False)
    ...
    in_open_1[start_r, start_c]	= True
